      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
              builder:
                  (context) => StrategySelectionScreen(
                    difficulty: difficulty,
                  ), //my new function added
                      ...
                      itemBuilder: (context, index) {
                        return FadeInSlide(
                          ...
                          child: _buildRuleItem(
                            rules[index]["icon"] as IconData,
                            rules[index]["text"] as String,
                          ),
                        );
                      },
                    ),
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder:
                                    (context) => SudokuBoardScreen(
                                      difficulty:
                                          "medium", // Default to medium difficulty
                                      strategyExplanation: () {
                                        return "This is a general game with all strategies. Play carefully and apply the techniques you've learned!";
                                      },
                                      generalMode: true,
                                    ),
                              ),
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                Colors
                                    .green
                                    .shade600, // Different color to distinguish
                            foregroundColor: Colors.white,
                            elevation: 10,
                            padding: const EdgeInsets.symmetric(
                              horizontal: 32,
...
class FadeInSlide extends StatefulWidget {
  ...
  const FadeInSlide({required this.child, this.delay = Duration.zero, Key? key})
    : super(key: key);
